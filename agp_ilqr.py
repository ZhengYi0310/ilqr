...
class AGP_iLQR(BaseTrajOptimizer):
    ...
    def __init__(self, sys_dynamics_GP, cost_func, time_steps, max_reg=1e10, use_second_order=False):
        """
    ...
    def update_u(self, x0, u_seq_init, n_interations=100, tolerance=1e-6, on_iteration=None, line_search_steps=10, scale=0.8):
        """
            ...
            try:
                ...
                for alpha in alphas:
                    ...
                    if J_opt_new < J_opt:
                        ...
                        if np.abs((J_opt_new - J_opt) / expected_delta_J) < scale:
                            converged = True
                        J_opt = J_opt_new
                        xs = xs_new
                        us = us_new
